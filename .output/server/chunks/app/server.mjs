...
const vueuseHead_0748c3c2 = defineNuxtPlugin((nuxtApp) => {
...
const plugin_3b9b8094 = defineNuxtPlugin((nuxtApp) => {
...
const routes = [
  {
    "name": "about",
    "path": "/about",
    "file": "/Users/ankit.agarwal/Documents/poc/nuxt3-starter/nuxt-starter-kit/pages/about.vue",
    "children": [],
...
const router_0100cbae = defineNuxtPlugin((nuxtApp) => {
